      ...
      <Sec>
        <MainSubSec>
          <SubSec>
            ...
            <H2 data-aos={"zoom-in"}>Chat With Us On</H2>
            <P data-aos={"zoom-out"} data-aos-duration={"1500"}>
              +94 77 777 7777 <br /> +94 77 777 7777
            </P>
          </SubSec>
          <SubSec>
            <Icon data-aos={"zoom-in-up"}>
          ...
          <SubSec>
            <Icon data-aos={"zoom-in"} data-aos-duration={"1500"}>
            ...
            <P data-aos={"zoom-out"} data-aos-duration={"1500"}>
              No.999 <br /> Unknown Street <br /> Main City
            </P>
          </SubSec>
          <SubSec>
            <Icon data-aos={"zoom-in"} data-aos-duration={"1500"}>
