                                ...
                                <l.CartSection>
                                    <l.ItemsCard>
                                        <l.SubText>
                                                ...
                                                <l.Text>
                                                    Price : Rs. {cart.TotalPrice}
                                                </l.Text>
                                                <l.Text>
                                                    Status : {cart.Status} <l.Icon1> 
                                                                                {
                                                                                    cart.Status === "Confirm" ? <TiTick/> : <BsHourglassSplit/>
                                                                                }
                                                                            </l.Icon1>
                                                </l.Text>
                                                <l.Text>
                                                    Delivery Status : {cart.DeliveryStatus}  <l.Icon1> 
                                                                                                {
                                                                                                    cart.DeliveryStatus === "Delivered" ? <TiTick/> : <BsHourglassSplit/>
                                                                                                }
                                                                                            </l.Icon1>
                                                </l.Text>
                                            </l.SubText>
