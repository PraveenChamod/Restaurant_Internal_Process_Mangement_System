        ...
        <l.SubContainer>
          <l.SubSection1>
            <l.OrderUserDetails>
              ...
              <l.UserDetails>Address To : {user?.Address}</l.UserDetails>
                  ...
                  <l.CartSection>
                    <l.ItemsCard>
                      ...
                      <l.Details>
                        ...
                        <l.SubText>
                          <l.Text>Quantity : {cart.quantity}</l.Text>
                          <l.Text>Price : {cart.quantity * cart.price}</l.Text>
                        </l.SubText>
                      </l.Details>
                    </l.ItemsCard>
                  </l.CartSection>
            ...
            <l.Right>
              <l.Description>
                ...
                <l.RadioButtonSection>
                  ...
                  {paymentMethod === "Card Payments" ? <CardElement /> : null}
                </l.RadioButtonSection>
                <l.ButtonSection>
                  <FormButton
                    style={{ width: "200px" }}
