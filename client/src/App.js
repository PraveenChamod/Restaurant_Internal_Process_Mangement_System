          ...
          <div className="App">
            ...
            <Routes>
              ...
              >
                <Route
                  path="/login"
                  element={<LoginPg ScrollToTop={scrollToTop} />}
                />
                <Route
                  path="/FrogotPassword"
                ...
                <Route
                  path="/AdminView-User"
                  element={<AdminViewUser BackRoutes={BackRoutes[0].nav} />}
                />
                <Route
                  path="/AdminMy-Profile"
                  element={
                    <AdminUserProfile
                      route={EditProfileLinks[0]}
                      BackRoutes={BackRoutes[0].nav}
                    />
                  }
                />
                <Route
                ...
                <Route
                  ...
                  element={<AdminViewTables BackRoutes={BackRoutes[0].nav} />}
                />
                <Route
                ...
                <Route
                  ...
                  element={<AdminViewFoods BackRoutes={BackRoutes[0].nav} />}
                />
                ...
                <Route
                  ...
                  element={<ManagerViewUser BackRoutes={BackRoutes[1].nav} />}
                />
                <Route
                  path="/ManagerMy-Profile"
                  element={
                    <ManagerUserProfile
                ...
                />
                <Route
                  path="/ManagerReport-Generation"
                  element={<ReportGeneration BackRoutes={BackRoutes[1].nav} />}
                />
                <Route
                  path="/ManagerReportPreview"
                ...
                <Route
                  ...
                  element={<ViewStock BackRoutes={BackRoutes[1].nav} />}
                />
                <Route
                  path="/ManagerViewItem/:SerialNo"
                  element={<ViewItem />}
                />
                <Route
                ...
                <Route
                  ...
                  element={<ManagerViewTables BackRoutes={BackRoutes[1].nav} />}
                />
                <Route
                  path="/ManagerView-Table/:id"
                  element={<ManagerViewTableDetails />}
                />
                <Route
                ...
                <Route
                  ...
                  element={<ManagerViewFoods BackRoutes={BackRoutes[1].nav} />}
                />
                <Route
                  path="/ManagerView-Food/:id"
                  element={<ManagerViewFood />}
                />
                <Route
                  path="/ManagerView-Offers"
                  element={<ManagerViewOffers BackRoutes={BackRoutes[1].nav} />}
                />
                <Route
                  path="/ManagerView-Offer/:id"
                  element={<ManagerViewOffer />}
                />
                <Route
                ...
                <Route
                  ...
                  element={<ViewSupplierOrder BackRoutes={BackRoutes[1].nav} />}
                />
                <Route
                  path="/ManagerView-supllierorder-details/:id"
                  element={<ViewSupplierOrderDetails />}
                />
                <Route
                ...
                />
                <Route
                  path="/Staff-MemberView-Offers"
                  element={
                    <StaffMemberViewOffers BackRoutes={BackRoutes[2].nav} />
                  }
                />
                <Route
                  path="/Staff-MemberView-Offer"
                  element={
                    <StaffMemberViewOffer BackRoutes={BackRoutes[2].nav} />
                  }
                />
                <Route
                  path="/Staff-MemberView-Foods"
                  element={
                    <StaffMemberViewFoods BackRoutes={BackRoutes[2].nav} />
                  }
                />
                <Route
                ...
                />
                <Route
                  path="/Staff-MemberPendingTable-Reservation-Details"
                  element={
                    <StaffMemberPendingReservations
                      BackRoutes={BackRoutes[2].nav}
                    />
                  }
                />
                <Route
                  path="/Staff-MemberTable-Reservation-Details/:id"
                  element={
                ...
                />
                <Route
                  path="/Staff-MemberMy-Profile"
                  element={
                    <StaffMemberUserProfile
                      route={EditProfileLinks[2]}
                      BackRoutes={BackRoutes[2].nav}
                    />
                  }
                />
                <Route
                  path="/Staff-MemberEdit-Profile"
                  element={
                ...
                <Route
                  ...
                  element={<CustomerDashBoard Navs={Roles[5]} />}
                />
                <Route
                ...
                />
                <Route
                  path="/CustomerMy-Orders"
                  element={<MyOrders BackRoutes={BackRoutes[3].nav} />}
                />
                <Route
                  path="/CustomerDelivery-Tracking"
                  element={<DeliveryTracking />}
                ...
                />
                <Route
                  path="/DelivererMy-Profile"
                  element={
                    <DelivererUserProfile
                      route={EditProfileLinks[3]}
                      BackRoutes={BackRoutes[4].nav}
                    />
                  }
                />
                <Route
                  path="/DelivererEdit-Profile"
                  element={
                ...
                />
                <Route
                  path="/DelivererAllOrderDetails"
                  element={<AllOrderDetails BackRoutes={BackRoutes[4].nav} />}
                />
                <Route
                ...
                />
                <Route
                  path="/SupplierMy-Profile"
                  element={
                    <SupplierUserProfile
                      route={EditProfileLinks[4]}
                      BackRoutes={BackRoutes[5].nav}
                    />
                  }
                />
                <Route
                  path="/SupplierEdit-Profile"
                  element={
                    <SupplierEditProfile
