...
import {  AddReview, AddToCart, OrderItem, PlaceOrder, RegisterCustomer, removeFoodFromCart, ReserveTable, UpdateProfile, viewCart } from '../controllers/CustomerControll.js';
...
Customerrouter.route('/RemoveCartItem').patch(requireAuth,removeFoodFromCart);
